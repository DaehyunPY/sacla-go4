...
Bool_t conpar_online_auto()
{
	...
	x[0] = 40;	y[0] = 0;
	x[1] = 38.637;	y[1] = 10.3528;
	x[2] = 34.641;	y[2] = 20;
	x[3] = 28.2843;	y[3] = 28.2843;
	x[4] = 20;	y[4] = 34.641;
	x[5] = 10.3528;	y[5] = 38.637;
	x[6] = 2.44929e-15;	y[6] = 40;
	x[7] = -10.3528;	y[7] = 38.637;
	x[8] = -20;	y[8] = 34.641;
	x[9] = -28.2843;	y[9] = 28.2843;
	x[10] = -34.641;	y[10] = 20;
	x[11] = -38.637;	y[11] = 10.3528;
	x[12] = -40;	y[12] = 4.89859e-15;
	x[13] = -38.637;	y[13] = -10.3528;
	x[14] = -34.641;	y[14] = -20;
	x[15] = -28.2843;	y[15] = -28.2843;
	x[16] = -20;	y[16] = -34.641;
	x[17] = -10.3528;	y[17] = -38.637;
	x[18] = -7.34788e-15;	y[18] = -40;
	x[19] = 10.3528;	y[19] = -38.637;
	x[20] = 20;	y[20] = -34.641;
	x[21] = 28.2843;	y[21] = -28.2843;
	x[22] = 34.641;	y[22] = -20;
	x[23] = 38.637;	y[23] = -10.3528;
	x[24] = 40;	y[24] = 0;
	...
	SetWindowCondition("c_Tsum_ui", 60, 68, 0, 0);
	SetWindowCondition("c_Tsum_vi", 68, 73, 0, 0);
	SetWindowCondition("c_Tsum_wi", 66.7465, 74.0781, 0, 0);
	...
	DataMembers = OpenParameter ("Par i hexanode");
		SetParameterMember (DataMembers, "scaleU", "1.15");
		...
		SetParameterMember (DataMembers, "xo", "-1");
		SetParameterMember (DataMembers, "yo", "0");
		SetParameterMember (DataMembers, "phi", "0");
		SetParameterMember (DataMembers, "size_raw", "149");
