...
Bool_t conpar_online()
{
	...
	SetWindowCondition("c_Tsum_ui", 61.1156, 77.3646, 0, 0);
	SetWindowCondition("c_Tsum_vi", 68.2568, 83.5382, 0, 0);
	SetWindowCondition("c_Tsum_wi", 64.8609, 86.2063, 0, 0);
