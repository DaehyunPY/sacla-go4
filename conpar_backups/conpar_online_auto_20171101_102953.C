...
Bool_t conpar_online_auto()
{
	...
	SetWindowCondition("c_Tsum_ue", 0, 300, 0, 0);
	SetWindowCondition("c_Tsum_ve", 0, 300, 0, 0);
	SetWindowCondition("c_Tsum_we", 0, 300, 0, 0);
	SetWindowCondition("c_Sort_ue1", -100, 900, 0, 0);
	SetWindowCondition("c_Sort_ue2", -100, 900, 0, 0);
	SetWindowCondition("c_Sort_ve1", -100, 900, 0, 0);
	SetWindowCondition("c_Sort_ve2", -100, 900, 0, 0);
	SetWindowCondition("c_Sort_we1", -100, 900, 0, 0);
	SetWindowCondition("c_Sort_we2", -100, 900, 0, 0);
	...
	SetWindowCondition("c_Tsum_ui", 0, 300, 0, 0);
	SetWindowCondition("c_Tsum_vi", 0, 300, 0, 0);
	SetWindowCondition("c_Tsum_wi", 0, 300, 0, 0);
	...
	DataMembers = OpenParameter ("Par Chan 16 Acq Tdc CFD");
		SetParameterMember (DataMembers, "Threshold", "30");
		SetParameterMember (DataMembers, "Delay", "4");
		SetParameterMember (DataMembers, "Fraction", "0.5");
		SetParameterMember (DataMembers, "Walk", "0");
	SaveParameter (DataMembers, "Par Chan 16 Acq Tdc CFD");
	...
	DataMembers = OpenParameter ("Par e hexanode");
		...
		SetParameterMember (DataMembers, "scaleV", "1");
		SetParameterMember (DataMembers, "scaleW", "1");
		...
		SetParameterMember (DataMembers, "size_raw", "210");
